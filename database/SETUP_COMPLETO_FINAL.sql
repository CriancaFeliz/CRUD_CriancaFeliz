...
CREATE TABLE IF NOT EXISTS `ficha_socioeconomico` (
  ...
  `tipo_agua` varchar(100) DEFAULT NULL,
  `tipo_esgoto` varchar(100) DEFAULT NULL,
  `tipo_energia` varchar(100) DEFAULT NULL,
  `renda_familiar` decimal(10,2) DEFAULT 0,
  `renda_per_capita` decimal(10,2) DEFAULT NULL,
  `renda_salario` decimal(10,2) DEFAULT 0,
  `renda_bolsa` decimal(10,2) DEFAULT 0,
  ...
  `veiculos_motocicleta` int(11) DEFAULT 0,
  `veiculos_automovel` int(11) DEFAULT 0,
  `veiculos_caminhonete` int(11) DEFAULT 0,
  `veiculos_caminhao` int(11) DEFAULT 0,
  `veiculos_outros` int(11) DEFAULT 0,
  `observacoes` longtext DEFAULT NULL,
  `trabalho_clt` tinyint(1) DEFAULT 0,
  `trabalho_clt_qual` varchar(255) DEFAULT NULL,
  `convenio_medico` tinyint(1) DEFAULT 0,
