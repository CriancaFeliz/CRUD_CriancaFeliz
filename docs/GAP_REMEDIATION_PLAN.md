...
| --- | --- | --- | --- |
| Testes | Regressões invisíveis antes de produção | Runner PHP, testes unitários básicos, teste de exportação CSV e CI | Testes de integração com MySQL Docker e fluxos HTTP |
