 ...
 * e gera os comandos SQL necessÃ¡rios para criÃ¡-las.
 * 
 * Acesso: http://localhost/CriancaFeliz/tools/diagnostics/check_ficha_columns.php
 */
...
<body>
    <div class="container">
        <div class="header">
            <h1>ðŸ” Verificador de Colunas</h1>
        ...
        <div class="card">
            <?php if (!$connectionOk): ?>
                <div class="error">
                    <h3>âŒ Erro de ConexÃ£o</h3>
                    <p>NÃ£o foi possÃ­vel conectar ao banco de dados:</p>
                    <pre><?php echo htmlspecialchars($connectionError); ?></pre>
                    <p>Verifique a configuraÃ§Ã£o do banco em <code>app/Config/Database.php</code></p>
                </div>
            <?php else: ?>
                <div class="stat">
                    <div class="stat-box">
                ...
                <?php if (empty($missingColumns)): ?>
                    <div class="success">
                        <h3>âœ… Tudo Perfeito!</h3>
                        <p>Todas as colunas esperadas existem na tabela <code>Ficha_Socioeconomico</code>.</p>
                        <p>VocÃª pode usar a aplicaÃ§Ã£o normalmente.</p>
                    </div>
                <?php else: ?>
                    <div class="warning">
                        <h3>âš ï¸ Colunas Faltando</h3>
                    ...
                    <div class="info">
                        <h3>âœ¨ Comandos SQL para Criar as Colunas</h3>
                ...
                <div class="info">
                    <h3>ðŸ“‹ Colunas Existentes</h3>
                    <p>Essas colunas jÃ¡ estÃ£o presentes na tabela:</p>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Coluna</th>
                ...
                <div class="info">
                    ...
                    <ol style="margin-left: 20px; line-height: 1.8;">
                        ...
                        <li>Refresque esta pÃ¡gina para confirmar</li>
                    </ol>
                </div>

                <p style="margin-top: 20px; text-align: center; color: #6c757d;">
                    <a href="check_ficha_columns.php" class="button">ðŸ”„ Recarregar</a>
                </p>
            <?php endif; ?>
        </div>
    </div>
