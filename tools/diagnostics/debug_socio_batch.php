<?php
/**
 * Debug em lote de fichas socioeconÃ´micas
...
try {
    ...
    // Pegar Ãºltimos atendidos com ficha (ordenar por data_cadastro)
    ...
    echo "<h1>Debug em lote - Ãšltimas {$limit} fichas</h1>";
    echo "<p>Abrir individual: <code>debug_socio_ficha.php?id=&lt;id_atendido&gt;</code></p>";

    if (empty($rows)) {
        echo "<p>Nenhuma ficha encontrada (verifique se hÃ¡ registros em Ficha_Socioeconomico).</p>";
        exit;
    }
