...
try {
    ...
    echo "<h1>Debug Ficha socioeconÃ´mica - id_atendido={$id}</h1>";
    ...
    // VerificaÃ§Ãµes rÃ¡pidas de campos solicitados
    $checkFields = [
    ...
    echo "<h2>VerificaÃ§Ã£o rÃ¡pida de campos</h2>";
    echo "<table border=1 cellpadding=6 cellspacing=0 style=\"border-collapse:collapse;\">";
    echo "<tr><th>Campo</th><th>Valor (raw ficha)</th><th>Valor (mapped)</th><th>ComentÃ¡rio</th></tr>";
    foreach ($checkFields as $f) {
        ...
        if ($mappedVal === null || $mappedVal === '' || (is_numeric($mappedVal) && $mappedVal == 0 && in_array($f, ['despesa_agua','despesa_energia','renda_familiar','renda_per_capita']))) {
            $comment = 'Parece ausente/no DB -> "NÃ£o informado" na view';
        }
