...
if ($_SESSION['user_role'] !== 'admin') {
    $_SESSION['flash_error'] = 'Acesso negado. Apenas administradores podem gerenciar usuÃ¡rios.';
...
if ($action === 'create' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($password) || empty($role)) {
        $_SESSION['flash_error'] = 'Todos os campos sÃ£o obrigatÃ³rios';
    } else {
        ...
        if ($emailExists) {
            $_SESSION['flash_error'] = 'Email jÃ¡ estÃ¡ em uso';
        } else {
            // Criar usuÃ¡rio
            $newUser = [
                'id' => uniqid('user_'),
            ...
            $_SESSION['flash_success'] = 'UsuÃ¡rio criado com sucesso!';
...
<head>
    ...
    <title>Gerenciar UsuÃ¡rios - Sistema CrianÃ§a Feliz</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div>
                <a href="dashboard.php" class="btn secondary">â† Voltar</a>
                <button onclick="openModal()" class="btn success">ðŸ‘¤ Novo UsuÃ¡rio</button>
            </div>
        </div>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="role" required>
                        ...
                        <option value="psicologo">PsicÃ³logo - Assistente Social</option>
                ...
                <div style="display: flex; gap: 10px; justify-content: flex-end;">
                    ...
                    <button type="submit" class="btn">Criar UsuÃ¡rio</button>
                </div>
            </form>
        </div>
    </div>
