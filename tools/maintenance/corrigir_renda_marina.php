...
if (isset($_GET['confirm']) && $_GET['confirm'] == '1') {
    ...
    echo "<br>";
    echo "<a href='?confirm=1' style='background: green; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;'>Confirmar Corre̤̣o</a>";
    echo " | ";
