...
try {
    ...
    // 2. Ver se hÃ¡ JSON com despesas ou renda
    echo "<hr>";
    echo "<h3>Campos com possÃ­veis rendas:</h3>";
    ...
    echo "<hr>";
    echo "<h3>CorreÃ§Ã£o Manual (se necessÃ¡rio):</h3>";
    echo "<p>Se o valor de 360000.00 estiver incorreto, vocÃª pode:</p>";
    echo "<ol>";
    echo "<li>Editar a ficha atravÃ©s do formulÃ¡rio e reenviar</li>";
    echo "<li>Ou clicar no botÃ£o abaixo para resettÃ¡-la para 0:</li>";
    echo "</ol>";
    ...
    if ($_GET['reset'] == 'marina') {
        $stmt = $db->query("
            ...
            WHERE idficha = 4
        ");
        echo "<p style='color: green; font-weight: bold;'>âœ“ Renda de Marina Carla resetada para 0!</p>";
    } else {
