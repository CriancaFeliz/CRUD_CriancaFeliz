 ...
 * Acesse: http://localhost/CriancaFeliz/tools/maintenance/fix_users_mysql.php
 */
...
try {
    ...
    echo "<hr>";
    echo "<h3>ðŸ” VerificaÃ§Ã£o no Banco:</h3>";
    ...
    echo "<h2>âŒ Erro ao conectar ao banco de dados</h2>";
